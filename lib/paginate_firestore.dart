      ...
      builder: (context, state) {
        if (state is PaginationInitial) {
          ...
          if ((widget.onError != null)) {
            return _buildWithScrollView(context, widget.onError!(state.error));
          } else {
        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildBuilderDelegate(
              ...
              childCount: max(0, (loadedState.hasReachedEnd ? loadedState.documentSnapshots.length : loadedState.documentSnapshots.length + 1) * 2 - 1),
            ),
          ),
        ),
        if (widget.footer != null) widget.footer!,
